...
class AddInvitation extends MineralSubcommand<GuildCommandInteraction> with State, Container, PandaMixins {
  AddInvitation(): super(label: Display("add"), description: Display("ajouter des invitations"), options: [
  ...
  Future<void> handle(CommandInteraction interaction) async {
    ...
    await inviteManager.edit(
        actuals: inviteManager.actual + actual,
        leaves: inviteManager.leaves + leaves,
        bonus: inviteManager.bonus + bonus);

    final embed = EmbedBuilder(
        title: "Succès !",
        description: "J'ai bien modifié les invitations de $user ${inviteManager.actual} actuelles(${inviteManager.total} au total, ${inviteManager.leaves} parties, ${inviteManager.bonus} bonus) !",
        color: Color.invisible);
